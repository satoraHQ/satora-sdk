...
public sealed class Client : IDisposable
{
    ...
    /// </param>
    /// <param name="contractDbPath">
    /// Optional SQLite DB path for ark-rs contract-manager state. If null,
    /// ark-rs uses its default <c>contracts.db</c> path.
    /// </param>
    public Client(
        string mnemonic,
